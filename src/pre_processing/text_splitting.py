...
def modify_pdf_content(pdf_path, headers_to_split_on):
    """
    Modify PDF content by adding markdown header based on user -defined configurations.
    """
    ...
    with open(pdf_path, "rb") as file:
        ...
        for page_num in range(pdf.getNumPages()):
            ...
            #Dynamically add markdown headers based on user-defined configurations
